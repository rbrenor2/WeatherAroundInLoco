...
class FlickrProvider {
    ...
    struct Keys {
        static let flickrKey = "5b4b446bd0675ec99ed23f0665e84c19"
    }
    ...
    class func fetchPhotosForSearchText(searchText: String, onCompletion: @escaping FlickrResponse) -> Void {
        ...
        let urlString: String = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(Keys.flickrKey)&tags=\(escapedSearchText)&per_page=1&page=1&format=json&nojsoncallback=1"
